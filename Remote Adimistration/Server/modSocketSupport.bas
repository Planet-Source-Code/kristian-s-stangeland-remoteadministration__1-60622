...
'visible from the clsSocket class module
...
Private Function WindowProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    'reference to the instance of the clsSocket class and calls
    ...
    If uMsg = p_lngWinsockMessage Then  'Modified: 04-MAR-2002
        '
        'All the pointers to the existing instances of the clsSocket class
        ...
        'instance of the clsSocket class. Since the wParam argument of the
        ...
        '
        'Forward the message to the instance of the clsSocket class
    ...
    ElseIf uMsg = m_lngResolveMessage Then  'Modified: 04-MAR-2002
        ...
        'instance of the clsSocket class. So, if we know a value
        ...
        '
        'A value of the pointer to the instance of the clsSocket class
        ...
        'pointer to the instance of the clsSocket class.
...
ERORR_HANDLER:
    '
    'Err.Raise Err.Number, "clsSocket.WindowProc", Err.Description
    '
    'GoTo EXIT_LABEL
    '
End Function
...
'           lngObjectPointer - pointer to an object, instance of the clsSocket class
...
'********************************************************************************
    ...
    If p_lngWindowHandle = 0 Then
        ...
        If p_lngWindowHandle = 0 Then
            ...
            Err.Source = "modSocketSupport.RegisterSocket"
            '---------------------------------------------------
    ...
    'is the pointer to the instance of the clsSocket class.
...
'Author    :Oleg Gdalevich
'Date/Time :17-12-2001
'Purpose   :Receives requests to resolve a host address from the clsSocket class.
...
'********************************************************************************
    ...
    'clsSocket class, this function can be called to start several
    ...
    'the instance of the clsSocket class and the item's data is the
    'Request ID, the value returned by the WSAAsyncGetHostByXXXX
    'Winsock API function. So in order to get the pointer to the
    'instance of the clsSocket class by the task ID value the following
    ...
    'pointer to the instance of clsSocket class we can use the following code:
    '
    'lngMemoryHandle = CLng(m_colMemoryBlocks("S" & lngObjPointer))
    '
    ...
    '   - which instance of the clsSocket class we need to post the info to
    '
    ...
    Else
        ...
        Err.Number = Err.LastDllError
        Err.Description = GetErrorDescription(Err.LastDllError)
        Err.Source = "modSocketSupport.ResolveHost"
        '
    End If
    '
End Function
...
Public Function InitWinsockService() As Long
    ...
    If Not m_blnWinsockInit Then
        ...
        If lngRetVal <> 0 Then
            ...
            End Select
            '
            Err.Raise Err.LastDllError, "modSocketSupport.InitWinsockService", strErrorMsg
            '
        Else
            '
    ...
    Else
        ...
        'instance of the clsSocket class, the code to init the
...
'procedure of any instance of the clsSocket class. But the WSACleanup
'Winsock API function is called only if the calling object is the
'last instance of the clsSocket class within the current process.
'********************************************************************************
    '
